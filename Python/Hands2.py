...
def show_controls(image):
    ...
    cv2.putText(image, 'Presiona "g" para aplicar/desactivar escala de grises', (10, 90), font, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(image, 'Presiona "c" para aplicar/desactivar Canny', (10, 120), font, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(image, 'Presiona "s" para aplicar/desactivar sepia', (10, 150), font, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(image, 'Presiona "i" para invertir colores', (10, 180), font, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
